...
<html>
            ...
            <section class="section section-hero">
               <div class="hero-box hero-box-pad">
                  <div class="container">
                        ...
                        <form action="php/cancelQuery.php" method="POST">
                        <input type="text" hidden value="" name="resDel" id="resDel"> </input>
   ...
   <script>   
      ...
      var allQues = <?php echo $_SESSION['customerReservationResult'];  ?>;
      console.log(allQues);
      ...
      for(var x = 0; x < allQues.length; x++){
         ...
         for(var y =0; y <= allQues[x].length; y++){
            ...
            if(y == 0){
               ...
               cell.appendChild(t);
               cell.setAttribute("name","res_id");
               cell.setAttribute("value", "asdasd");
               document.getElementById("row_"+x).appendChild(cell);
            }

            else if (y  < allQues[x].length && y != 0){
                  var t = document.createTextNode(allQues[x][y]);
                  cell.appendChild(t);
                  document.getElementById("row_"+x).appendChild(cell);
            }
                  ...
                  submit.setAttribute("value","cancel");
                  submit.setAttribute("id",temp);
                  submit.setAttribute("onclick","cancelRes(" + temp + ")");
                  submit.innerHTML = temp;
                  
                  submit.setAttribute("name", "sumbitCancel");
                  // STYLE
            ...
            function cancelRes(x) {
               alert(x);
               var id = document.getElementById('resDel');
               id.value = x;
