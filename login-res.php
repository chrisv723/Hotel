<?php
   ...
   $_SESSION['numDeluxe'] = $_POST["deluxeNum"];
   $_SESSION['numRegular'] = $_POST["regularNum"];
   ...
   echo $_SESSION['location'] . " " . $_SESSION['numDeluxe'] . " " . $_SESSION['numRegular'] . " " . $_SESSION['check_in']. " " . $_SESSION['check_out'] ;
