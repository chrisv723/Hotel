               ...
               <div class="hero-box hero-box-pad" >
                  ...
                  <div class="container-fluid" style="text-align: center;">
                        <!-- MAIN_CONTENT STARTS -->
                           ...
                           <div id="content">
                              <div class="p-3 mb-2 bg-danger text-white">Hilton</div>
                              <div class="p-3 mb-2 bg-primary text-white">Marriot</div>
                              <div class="p-3 mb-2 bg-success text-white">Westin</div>
                              <div class="p-3 mb-2 bg-dark text-white">Hyatt</div>
                              <div class="p-3 mb-2 bg-warning text-dark">Four Seasons</div>
                           </div>
                        <!-- MAIN_CONTENT ENDS -->
