...
<html>
   ...
   <body class="home" id="page">
                            ...
                            <div class="d-flex justify-content-center h-100">
                                <div class="user_card">
                                    ...
                                    <div class="d-flex justify-content-center form_container">
                                        ...
                                        <form action="php/customerRegisterProj2.php" method="post">
                                          <div class="input-group mb-3">
                                             <div class="input-group-append">
                                                 <span class="input-group-text"><i class="fas fa-user"></i></span>
                                             </div>
                                             <input type="text" id="usernameSIGNUP" name="name" class="form-control input_user" value="" placeholder="username" required>
                                         </div>
                                            <div class="input-group mb-3">
                                                <div class="input-group-append">
                                                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                                                </div>
                                                <input type="password" name="password" id="passSIGNUP" class="form-control input_user" value="" placeholder="password" required>
                                            </div>
                                            <div class="input-group mb-2">
                                                <div class="input-group-append">
                                                    <span class="input-group-text"><i class="fas fa-key"></i></span>
                                                </div>
                                                <input type="password" name="" class="form-control input_pass" value="" placeholder="confirm password" required>
                                            </div>
      ...
      <!-- Scripts -->
        ...
        var sameName = "<?php echo $_SESSION['dupName']; $_SESSION['dupName'] = "0"; ?>";
        if(sameName == "1")
