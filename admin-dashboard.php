      ...
      <header class="main-header">
         <div class="container">
            <div class="header-content">
               ...
               <!-- MAKE SURE TO COPY THE RIGHT NAVBAR FOR ALL OF THEM -->
               <nav class="site-nav">
               ...
               <div class="hero-box hero-box-pad">
                  <div class="container">
                        ...
                        <div class="hero-text align-center">
                           <h1>Welcome
                               <span id = "admin"><?php echo $_SESSION['Username']; ?></span> !</h1>
                        </div>
                        <div class="container-fluid" style="text-align: center;">

                          <div style="padding: 70px 0; width: 50%; display: inline-block;">
                              <button type="button" class="btn btn-primary btn-block" onclick="window.location.href='addingHotel.php';" >Add New Hotel Location</button>
                              <button type="button" class="btn btn-primary btn-block" onclick="window.location.href='php/reservationsAdmin.php';">Check Customer Reservations</button>
                              <button type="button" class="btn btn-primary btn-block" onclick="window.location.href='php/reservationsAdmin.php';">NEEDS WORKCancel Customer Reservations</button>
                          </div>
                        </div>
